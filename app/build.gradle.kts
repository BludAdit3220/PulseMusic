...
val baseApplicationId = "com.pulsemusic.music"
val applicationIdOverride = System.getenv("PULSEMUSIC_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("PULSEMUSIC_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("PULSEMUSIC_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("PULSEMUSIC_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("PULSEMUSIC_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("PULSEMUSIC_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 1
        versionName = "1.0.0"
        resValue("string", "app_name", appNameOverride ?: "PulseMusic")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "PulseMusic Debug")
            }
            signingConfig =
