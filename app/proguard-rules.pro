...
# Since PulseMusic is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WEB_REMIX Streaming - WebView JavaScript interfaces
-keepclassmembers class com.pulsemusic.music.utils.sabr.EjsNTransformSolver$SolverWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.pulsemusic.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.pulsemusic.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.pulsemusic.music.utils.cipher.** { *; }
-keep class com.pulsemusic.music.utils.sabr.** { *; }
-keep class com.pulsemusic.music.utils.potoken.** { *; }
...
-keep class com.pulsemusic.music.models.PersistQueue { *; }
-keep class com.pulsemusic.music.models.PersistPlayerState { *; }
-keep class com.pulsemusic.music.models.QueueData { *; }
-keep class com.pulsemusic.music.models.QueueType { *; }
-keep class com.pulsemusic.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.pulsemusic.music.cast.** { *; }
...
-keep class com.pulsemusic.music.recognition.VibraSignature { *; }
-keepclassmembers class com.pulsemusic.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.pulsemusic.music.listentogether.proto.** { *; }
-keepclassmembers class com.pulsemusic.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.pulsemusic.shazamkit.models.** { *; }
-keepclassmembers class com.pulsemusic.shazamkit.models.** {
    *;
}
...
-keepclasseswithmembers class com.pulsemusic.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
