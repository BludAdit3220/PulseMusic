...
#if PULSEMUSIC_ENABLE_DISCORD_SOCIAL_SDK
...
constexpr const char* kTag = "PulseMusicDiscord";
...
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeIsSdkEnabled(
    JNIEnv*,
    jobject)
{
#if PULSEMUSIC_ENABLE_DISCORD_SOCIAL_SDK
...
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeStart(
    JNIEnv* env,
    jobject,
    jlong applicationId,
    jstring accessToken)
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeUpdatePresence(
    JNIEnv* env,
    jobject,
    jlong applicationId,
    jstring accessToken,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeClearPresence(
    JNIEnv* env,
    jobject)
{
#if PULSEMUSIC_ENABLE_DISCORD_SOCIAL_SDK
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeClose(
    JNIEnv* env,
    jobject)
{
#if PULSEMUSIC_ENABLE_DISCORD_SOCIAL_SDK
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_pulsemusic_music_discord_DiscordSocialNativeBridge_nativeRunCallbacks(
    JNIEnv* env,
    jobject)
{
#if PULSEMUSIC_ENABLE_DISCORD_SOCIAL_SDK
