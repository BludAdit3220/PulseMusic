            ...
            remember {
                songSelection
                    .map { song ->
                        ...
                        val metadata = song.toMediaMetadata()
                        com.pulsemusic.music.db.entities.Song(
                            song =
                                com.pulsemusic.music.db.entities.SongEntity(
                                    id = metadata.id,
                            ...
                            artists =
                                metadata.artists.map { artist ->
                                    com.pulsemusic.music.db.entities.ArtistEntity(
                                        id = artist.id ?: "",
                                        name = artist.name,
                                    )
                                },
                            album =
                                metadata.album?.let { album ->
                                    com.pulsemusic.music.db.entities.AlbumEntity(
                                        id = album.id,
                                        title = album.title,
