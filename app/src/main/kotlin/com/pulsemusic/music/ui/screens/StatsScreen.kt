...
import com.pulsemusic.music.constants.CONTENT_TYPE_ARTIST
...
import com.pulsemusic.music.ui.component.ChoiceChipsRow
...
import com.pulsemusic.music.ui.component.LocalAlbumsGrid
import com.pulsemusic.music.ui.component.LocalArtistsGrid
import com.pulsemusic.music.ui.component.LocalMenuState
import com.pulsemusic.music.ui.component.LocalSongsGrid
import com.pulsemusic.music.ui.component.NavigationTitle
import com.pulsemusic.music.ui.component.PlaylistGridItem
import com.pulsemusic.music.ui.component.TimeTransfer
...
// Helper actions:
    val toggleArtistSelection: (MediaMetadata.Artist) -> Unit = { artist ->
        if (sArtists.any { it.id != null && it.id == artist.id }) {
            sArtists.removeAll { it.id != null && it.id == artist.id }
        } else {
            sArtists.add(artist)
        }
    }
        ...
        LazyColumn(
            ...
            if (isSearching) {
                items(
                    ...
                    val uiArtist = MediaMetadata.Artist(name = artist.artist.name, id = artist.id)
                    ...
                    Row( // Use a row to arrange the checkbox and ArtistListItem horizontally
                        ...
                        Checkbox(
                            checked = sArtists.contains(MediaMetadata.Artist(name = artist.artist.name, id = artist.id)), // Get the current checked state
                            onCheckedChange = {
                                toggleArtistSelection(uiArtist)
                            },
                        )
