...
import com.pulsemusic.music.constants.EnableGoogleCastKey
...
import com.pulsemusic.music.constants.VarispeedKey
...
import com.pulsemusic.music.ui.component.SleepTimerDialog
import com.pulsemusic.music.constants.SleepTimerEnabledKey
import com.pulsemusic.music.constants.SleepTimerRepeatKey
import com.pulsemusic.music.constants.SleepTimerCustomDaysKey
import com.pulsemusic.music.constants.SleepTimerEndTimeKey
import com.pulsemusic.music.constants.SleepTimerStartTimeKey
import com.pulsemusic.music.constants.SleepTimerDayTimesKey
import com.pulsemusic.music.ui.component.decodeDayTimes
import com.pulsemusic.music.ui.component.encodeDayTimes
...
fun PlayerSettings(
    ...
    val (enableWaveAnimation, onEnableWaveAnimationChange) = rememberPreference(
        EnableWaveAnimationKey,
        defaultValue = true
    )
        ...
        Material3SettingsGroup(
            ...
            items = buildList {
                ...
                add(Material3SettingsItem(
                    ...
                    title = { Text(stringResource(R.string.enable_wave_animation)) },
                    description = { Text(stringResource(R.string.enable_wave_animation_desc)) },
                    trailingContent = {
                        Switch(
                            checked = enableWaveAnimation,
                            onCheckedChange = onEnableWaveAnimationChange,
                            thumbContent = {
                                Icon(
                                    painter = painterResource(
                                        id = if (enableWaveAnimation) R.drawable.check else R.drawable.close
                                    ),
                                    contentDescription = null,
                                    modifier = Modifier.size(SwitchDefaults.IconSize)
                                )
                    ...
                    onClick = { onEnableWaveAnimationChange(!enableWaveAnimation) }
                ))
            }
        )
