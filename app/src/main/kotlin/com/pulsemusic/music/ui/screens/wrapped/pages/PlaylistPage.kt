package com.pulsemusic.music.ui.screens.wrapped.pages
...
import com.pulsemusic.music.ui.screens.wrapped.WrappedArtworkGenerator
...
import com.pulsemusic.music.ui.screens.wrapped.LocalWrappedManager
import com.pulsemusic.music.ui.screens.wrapped.PlaylistCreationState
import com.pulsemusic.music.ui.screens.wrapped.WrappedConstants
import com.pulsemusic.music.ui.screens.wrapped.components.AnimatedBackground
import com.pulsemusic.music.ui.screens.wrapped.components.AutoResizingText
import com.pulsemusic.music.ui.screens.wrapped.components.ShapeType
import com.pulsemusic.music.ui.theme.bbh_bartle
...
fun PlaylistPage() {
    ...
    val playlistBitmap = remember {
        WrappedArtworkGenerator.generate(context)
    }
            ...
            Button(
                onClick = {
                    if (playlistCreationState == PlaylistCreationState.Idle) {
                        manager.createPlaylist("personalized")
                    }
                },
                shape = CircleShape,
