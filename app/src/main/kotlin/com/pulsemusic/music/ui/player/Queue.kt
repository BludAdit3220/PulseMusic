...
import com.pulsemusic.music.constants.QueueEditLockKey
...
import com.pulsemusic.music.ui.component.MediaMetadataListItem
import com.pulsemusic.music.ui.menu.AddToPlaylistDialog
import com.pulsemusic.music.ui.menu.PlayerMenu
import com.pulsemusic.music.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.pulsemusic.music.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.pulsemusic.music.together.TogetherSessionState.Joined).role is com.pulsemusic.music.together.TogetherRole.Guest
                                            ...
                                            onClick = {
                                                if (selection) {
                                                    ...
                                                    if (index == currentWindowIndex) {
                                                        ...
                                                        val joined =
                                                            togetherSessionState as? com.pulsemusic.music.together.TogetherSessionState.Joined
                                                        val isGuest = joined?.role is com.pulsemusic.music.together.TogetherRole.Guest
                                                        if (isGuest) {
