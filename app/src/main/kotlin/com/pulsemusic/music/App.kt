...
import com.pulsemusic.music.constants.*
import com.pulsemusic.music.extensions.*
import com.pulsemusic.music.ui.screens.settings.ThemePalettes
import com.pulsemusic.music.ui.theme.ThemeSeedPalette
import com.pulsemusic.music.ui.theme.ThemeSeedPaletteCodec
...
import com.pulsemusic.music.utils.clearPlaybackWebAuthSession
import com.pulsemusic.music.utils.clearPlaybackAuthSession
import com.pulsemusic.music.innertube.YouTube
import com.pulsemusic.music.innertube.models.YouTubeLocale
import com.pulsemusic.music.kugou.KuGou
import com.pulsemusic.music.lastfm.LastFM
import com.pulsemusic.music.canvas.PulseMusicCanvas
import com.pulsemusic.music.ui.player.CanvasArtworkPlaybackCache
...
import com.pulsemusic.music.utils.toPlaybackAuthState
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(com.pulsemusic.music.utils.GlobalLogTree())
        } catch (_: Exception) {}
    ...
    private fun initializeCriticalSync() {
        ...
        PulseMusicCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
