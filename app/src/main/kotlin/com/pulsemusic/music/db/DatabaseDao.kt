...
package com.pulsemusic.music.db
...
import com.pulsemusic.music.db.entities.AlbumArtistMap
import com.pulsemusic.music.db.entities.AlbumEntity
import com.pulsemusic.music.db.entities.PlayCountEntity
import com.pulsemusic.music.db.entities.AlbumWithSongs
...
import com.pulsemusic.music.db.entities.EventWithSong
...
import com.pulsemusic.music.db.entities.SongAlbumMap
import com.pulsemusic.music.db.entities.SongArtistMap
import com.pulsemusic.music.db.entities.SongEntity
import com.pulsemusic.music.db.entities.ListeningBySlot
import com.pulsemusic.music.db.entities.SongWithStats
import com.pulsemusic.music.db.entities.TagEntity
import com.pulsemusic.music.db.entities.PlaylistTagMap
import com.pulsemusic.music.db.entities.PlaylistWithTags
import com.pulsemusic.music.extensions.reversed
import com.pulsemusic.music.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    @Query(
        ...
        SELECT s.id, s.title, s.thumbnailUrl, s.isVideo,
               (SELECT name FROM artist WHERE id = sam.artistId LIMIT 1) as artistName,
               (SELECT COUNT(1)
                FROM event
                WHERE songId = s.id
    ...
    @Query("SELECT SUM(totalPlayTime) FROM song WHERE id = :songId")
    suspend fun getTotalPlayTimeForSong(songId: String): Long?
    ...
    // ── Range-count helpers (used by WrappedManager) ─────────────────────────
    ...
    // ── addSongsToPlaylist (alias used by WrappedManager & StatsViewModel) ────
    ...
    fun addSongsToPlaylist(
        ...
        val songsToInsert = songs.mapNotNull { (id, setVideoId) ->
        ...
        update(playlist.playlist.copy(lastUpdateTime = now))
    }
