...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.pulsemusic.music.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.pulsemusic.music.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.pulsemusic.music.together.JoinDecision -> {
