...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/PulseMusicGroup/PulseMusic"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "PulseMusic.apk" -> "universal" to "foss"
                name == "PulseMusic-with-Google-Cast.apk" -> "universal" to "gms"
