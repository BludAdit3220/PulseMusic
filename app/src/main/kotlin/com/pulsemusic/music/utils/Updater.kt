...
import com.pulsemusic.music.App
import com.pulsemusic.music.constants.GitHubReleasesEtagKey
import com.pulsemusic.music.constants.GitHubReleasesFingerprintKey
import com.pulsemusic.music.constants.GitHubReleasesJsonKey
import com.pulsemusic.music.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/BludAdit3220/PulseMusic/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "PulseMusic")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/BludAdit3220/PulseMusic/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/BludAdit3220/PulseMusic/releases/latest/download/"
