...
enum class StatPeriod {
    ...
    fun toLocalDateTime(): LocalDateTime =
        when (this) {
            WEEK_1 -> LocalDateTime.now().minusWeeks(1)
            MONTH_1 -> LocalDateTime.now().minusMonths(1)
            MONTH_3 -> LocalDateTime.now().minusMonths(3)
            MONTH_6 -> LocalDateTime.now().minusMonths(6)
            YEAR_1 -> LocalDateTime.now().minusMonths(12)
