...
import com.pulsemusic.music.constants.ListenTogetherAutoApprovalKey
import com.pulsemusic.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.pulsemusic.music.constants.ListenTogetherIsHostKey
import com.pulsemusic.music.constants.ListenTogetherRoomCodeKey
import com.pulsemusic.music.constants.ListenTogetherServerUrlKey
import com.pulsemusic.music.constants.ListenTogetherSessionTimestampKey
import com.pulsemusic.music.constants.ListenTogetherSessionTokenKey
import com.pulsemusic.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.pulsemusic.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.pulsemusic.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.pulsemusic.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.pulsemusic.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.pulsemusic.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.pulsemusic.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
