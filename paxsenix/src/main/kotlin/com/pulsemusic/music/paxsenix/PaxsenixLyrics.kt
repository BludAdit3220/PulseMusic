...
package com.pulsemusic.music.paxsenix
...
import com.pulsemusic.music.paxsenix.models.*
...
object PaxsenixLyrics {
    ...
    private val client by lazy {
        HttpClient(OkHttp) {
            ...
            defaultRequest {
                url(BASE_URL)
                header(HttpHeaders.UserAgent, "PulseMusic-Lyrics-Fetcher/1.0 (https://github.com/BludAdit3220/pulsemusic)")
