package com.pulsemusic.kugou

import com.pulsemusic.kugou.models.DownloadLyricsResponse
import com.pulsemusic.kugou.models.Keyword
import com.pulsemusic.kugou.models.SearchLyricsResponse
import com.pulsemusic.kugou.models.SearchSongResponse
...
object KuGou {
    ...
    suspend fun getLyrics(title: String, artist: String, duration: Int, album: String? = null): Result<String> =
        runCatching {
            ...
            Timber.tag("KuGou").e(e, "Error fetching lyrics for $title - $artist")
        }
