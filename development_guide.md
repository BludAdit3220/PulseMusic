# PulseMusic Dev Guide

This file outlines the process of setting up a local dev environment for PulseMusic.
...
```bash
git clone https://github.com/PulseMusicGroup/PulseMusic
cd PulseMusic
