package com.pulsemusic.music.betterlyrics

import com.pulsemusic.music.betterlyrics.models.TTMLResponse
...
object BetterLyrics {
    ...
    private suspend fun fetchTTML(
        ...
        if (response.status == HttpStatusCode.OK) {
            ...
            Timber.tag("BetterLyrics").w("Failed to fetch lyrics: ${response.status}")
            null
        }
    }.onFailure { e ->
        Timber.tag("BetterLyrics").e(e, "Error fetching lyrics from BetterLyrics")
    }.getOrNull()
