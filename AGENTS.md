# Working with PulseMusic as an AI agent

PulseMusic is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
6. All string edits should be made to the `app/src/main/res/values/pulse_music_strings.xml` file, NOT `app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `pulse_music_strings.xml` files in the project.
